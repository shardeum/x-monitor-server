...
function initLogger(baseDir, logsConfig) {
    console.log("initLogger")
    let logger = new Logger(baseDir, logsConfig)
    module.exports.mainLogger = logger.getLogger('main')
    module.exports.historyLogger = logger.getLogger('history')
    module.exports.errorLogger = logger.getLogger('errorFile')
}
